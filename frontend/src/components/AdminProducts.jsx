  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#4B0000] to-[#000000] text-white p-10">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold text-[#FFD700]">Products Management</h1>
        <button
      ...
      {showAddForm && (
        <div className="bg-black bg-opacity-80 p-6 rounded-xl mb-8">
          <h2 className="text-2xl font-bold text-[#FFD700] mb-4">Add New Product</h2>
          <form onSubmit={handleAddProduct} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <textarea
              ...
              className="p-2 rounded bg-gray-800 border border-gray-700 md:col-span-2"
              required
            />
            <button
              type="submit"
          ...
          {products.map((product) => (
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h3 className="text-xl font-semibold text-[#FFD700]">{product.name}</h3>
                  <p className="text-gray-400">Price: ${product.price} | Stock: {product.stockQuantity}</p>
                </div>
              </div>
              <button
